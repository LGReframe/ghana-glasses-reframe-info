        ...
        <div className="grid md:grid-cols-2 gap-12 items-center">
          <div>
            ...
            <p className="text-lg text-gray-600 mb-6 leading-relaxed">
              Enactus is a global community of student, academic and business leaders 
              committed to using the power of entrepreneurial action to improve the 
              quality of life and standard of living for people in need.
            </p>
            <p className="text-lg text-gray-600 mb-6 leading-relaxed">
              At Enactus Lüneburg, we believe in creating sustainable solutions that 
              generate both social impact and economic value. Our projects focus on 
              empowering communities while building viable business models.
            </p>
            <div className="flex items-center space-x-4">
              <div className="h-16 w-16 bg-gradient-to-br from-yellow-400 to-yellow-500 rounded-lg flex items-center justify-center">
                <img 
                  src="/lovable-uploads/24735b0c-8816-4b6c-85b9-323044f95e39.png" 
                  alt="Enactus Logo" 
          ...
          <div className="relative">
            <div className="bg-gradient-to-br from-gray-100 to-gray-200 rounded-2xl p-8 shadow-lg">
              <div className="grid grid-cols-2 gap-6 text-center">
                ...
                <div className="bg-white rounded-xl p-6 shadow-sm">
                  <h3 className="text-2xl font-bold text-gray-800">72,000+</h3>
